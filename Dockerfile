...
COPY src /opt/fraud_detection/src
...
COPY --from=builder /opt/fraud_detection/target/fraud_detection-*-SNAPSHOT.jar /opt/fraud_detection/fraud_detection.jar

ENV SPRING_PROFILES_ACTIVE prod
ENV CONFIG_LOCATION file:/opt/fraud_detection/config/
...
CMD [\
    ...
    "-jar", "/opt/fraud_detection/fraud_detection.jar", \
